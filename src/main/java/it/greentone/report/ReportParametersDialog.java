...
public abstract class ReportParametersDialog extends JDialog {
	...
	/**
	 * Finestra di dialogo per l'impostazione dei parametri del report da
	 * stampare.
	 */
	...
	/**
	 * Restituisce il titolo da dare al pannello di recupero dei parametri del
	 * report.
	 * 
	 * @return il titolo da dare al pannello di recupero dei parametri del
	 *         report
	 */
