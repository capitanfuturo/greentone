...
public class CalculatorDialog extends JDialog {
    ...
    /**
     * Esegue il calcolo a partire dal testo contenuto in {@link #getDisplayField()}
     */
    private void equalAction() {
        /*
         * eseguo il parsing della stringa, per farlo utilizzo la notazione polacca inversa RPN
         */
    ...
    public JButton getClearButton() {
        if (clearButton == null) {
            clearButton = new JButton(resourceMap.getIcon("viewCalc.Dialog.clearIcon"));
            clearButton.setToolTipText(resourceMap.getString("viewCalc.Dialog.clear"));
    ...
    /**
     * Restituisce il bottone che applica il risultato nel pannello delle operazioni.
     * 
     * @return il bottone che applica il risultato nel pannello delle operazioni
     */
    public JButton getApplyButton() {
        if (applyButton == null) {
            applyButton = new JButton(resourceMap.getIcon("viewCalc.Dialog.applyIcon"));
            applyButton.setToolTipText(resourceMap.getString("viewCalc.Dialog.apply"));
            applyButton.addActionListener(new ActionListener() {

                @Override
                public void actionPerformed(ActionEvent e) {
                    operationsPanel.getAmountTextField().setText(getDisplayField().getText().replace('.', ','));
                    getDisplayField().setText("");
                    setVisible(false);
                }
            });
    ...
    /**
     * A partire da una notazione infissa ne calcola la rappresentazione in polacca inversa.
     * 
     * @param input
    ...
    /**
     * A partire da una notazione polacca inversa rappresentata da uno stack ne calcola il risultato.
     * 
     * @param tks
