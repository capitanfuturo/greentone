 ...
 * </code> <br>
 * <br>
 * Pannello generico da estendere per poter avere delle facilities utili. Un pannello contestuale è composto da un
 * pannello di intestazione contenente le informazioni dell'oggetto selezionato nella tabella generale sottostante.
 * 
...
public abstract class ContextualPanel<T> extends AbstractPanel {
    ...
    /**
     * Restituisce il pannello superiore contenente tipicamente le informazioni dettagliate della tabella sottostante.
     * 
     * @return il pannello superiore contenente tipicamente le informazioni dettagliate della tabella sottostante
     */
    ...
    /**
     * Costruisce il pannello superiore contenente tipicamente le informazioni dettagliate della tabella sottostante.
     * 
     * @return il pannello superiore contenente tipicamente le informazioni dettagliate della tabella sottostante
     */
                        ...
                        SwingUtilities.invokeLater(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (selectedRow > -1) {
                                    int rowIndexToModel =
                                            getContentTable()
                                                    .convertRowIndexToModel(getContentTable().getSelectedRow());
    ...
    /**
     * Restituisce la barra degli strumenti delle azioni disponibili per il pannello corrente.
     * 
     * @return la barra degli strumenti delle azioni disponibili per il pannello corrente
     */
    ...
    /**
     * Abilita o disabilita tutti i componenti registrati {@link #registerComponent(JComponent)} del pannello di testata
     * 
     * @param enable
    ...
    /**
     * Inizializzazione della toolbar. Per accedere alla toolbar usare {@link #getContextualToolBar()}
     */
    protected abstract void initializeToolBar();

    /**
     * Utilizzare questo metodo per popolare il modello dei dati utili per l'interfaccia grafica
     */
    ...
    /**
     * Azioni da intraprendere per l'inserimento di una nuova riga della {@link #getContentTable()}.
     */
    ...
    /**
     * Azioni da intraprendere per la modifica di una riga della {@link #getContentTable()}.
     */
    ...
    /**
     * Porzione di codice che viene eseguita a seguito della selezione di un elemento nella tabella
     * {@link #getContentTable()}, in coda a {@link #initializeForEditing()}
     */
    ...
    /**
     * Porzione di codice che viene eseguita a seguito della perdita di selezione nella tabella
    ...
    /**
     * Restituisce a partire dalla riga di modello della tabella dei contenuti {@link #getContentTable()} un oggetto di
     * modello.
     * 
     * @param rowIndex
