...
public class SaveDocumentAction extends AbstractBean {
    ...
    public void saveDocument() {
        ...
        /*
         * se si tratta di una nuova entry creo un nuovo documento altrimenti modifico quella selezionata
         */
        Document document =
                documentsPanel.getStatus() == EStatus.EDIT ? documentsPanel.getSelectedItem() : new Document();
        /* compilo il bean */
        ...
        try {
            ...
            logger.getLogger()
                    .log(Level.WARNING, resourceMap.getString("ErrorMessage.copyingFile") + file.getPath(), e);
        }
    ...
    /**
     * Copia il nuovo file nel repository di GreenTone e restituisce l'URI del nuovo file
     * 
     * @param inputFile
