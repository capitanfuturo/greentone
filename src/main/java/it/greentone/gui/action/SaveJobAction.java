    ...
    public void saveJob() {
        ...
        if (dueDate != null) {
            if (dueDate.isBeforeNow()) {
                JOptionPane.showMessageDialog(jobsPanel, resourceMap.getString("saveJob.Action.dueDateBeforeNow"),
        ...
        if (startDate != null) {
            if (startDate.isAfterNow()) {
                JOptionPane.showMessageDialog(jobsPanel, resourceMap.getString("saveJob.Action.startDateAfterNow"),
                        resourceMap.getString("ErrorMessage.title"), JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        /*
         * la data di fine non può essere antecedente la data di inizio e non può essere posizionata nel futuro
         */
        if (finishDate != null) {
            ...
            if (finishDate.isAfterNow()) {
                JOptionPane.showMessageDialog(jobsPanel, resourceMap.getString("saveJob.Action.finishDateAfterNow"),
                        resourceMap.getString("ErrorMessage.title"), JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        ...
        /*
         * se si tratta di una nuova entry creo un nuovo incarico altrimenti modifico quella selezionato
         */
        ...
        /*
         * Issue 26: la data di inizio deve essere sempre impostata, se non presente viene assegnata automaticamente
         * alla data odierna.
         */
        ...
        String city =
                jobsPanel.getCityField().getSelectedItem() != null ? jobsPanel.getCityField().getSelectedItem()
                        .toString() : null;
        job.setCity(city);
        /* aggiorno la tabella */
