...
/**
 * Tabbedpane con supporto al drag & drop.
 * http://java-swing-tips.blogspot.com/2008/04/drag-and-drop-tabs-in-jtabbedpane
 * .html
 */
...
public class DnDTabbedPane extends JTabbedPane
{
	...
	private void autoScrollTest(Point glassPt)
	{
		...
		rBackward =
		  SwingUtilities.convertRectangle(getParent(), rBackward, glassPane);
		rForward =
		  SwingUtilities.convertRectangle(getParent(), rForward, glassPane);
	...
	/**
	 * Tabbedpane con supporto al drag & drop.
	 * http://java-swing-tips.blogspot.com/
	...
	{
		Point tabPt =
		  SwingUtilities.convertPoint(glassPane, glassPt, DnDTabbedPane.this);
		boolean isTB =
...
// when i move a tab the component disappear.
	...
	private void initTargetLeftRightLine(int next)
	{
		if(next < 0 || dragTabIndex == next || next - dragTabIndex == 1)
		{
			...
			{
				Rectangle r =
				  SwingUtilities.convertRectangle(this, getBoundsAt(0), glassPane);
				lineRect.setRect(r.x - LINEWIDTH / 2, r.y, LINEWIDTH, r.height);
			}
			else
			{
				Rectangle r =
				  SwingUtilities.convertRectangle(this, getBoundsAt(next - 1),
				    glassPane);
	...
	private void initGlassPane(Component c, Point tabPt)
	{
		...
		if(hasGhost())
		{
			...
			BufferedImage image =
			  new BufferedImage(c.getWidth(), c.getHeight(),
