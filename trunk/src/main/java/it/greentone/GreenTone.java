...
public class GreenTone extends SingleFrameApplication {
    ...
    /**
     * Esegue l'applicazione. Per il momento non sono disponibili argomenti di lancio.
     * 
     * @param args
    ...
    protected void initialize(String[] args) {
        ...
        /*
         * Imposto come directory di salvataggio delle proprietà grafiche del programma
         */
        ...
        applicationContext = new ClassPathXmlApplicationContext(GreenToneAppConfig.SPRING_CONFIG_LOCATION);
    ...
    protected void startup() {
        ...
        addExitListener(new ExitListener() {
            ...
            public boolean canExit(EventObject event) {
                /*
                 * se è richiesta la conferma di chiusura allora mostro una dialog
                 */
                if (springBeansHolder.getConfigurationProperties().isConfirmClosureActivated()) {
                    int confirmDialog =
                            JOptionPane.showConfirmDialog(mainPanel,
                                    getContext().getResourceMap().getString("exit.Action.confirmMessage"),
        ...
        if (springBeansHolder.getConfigurationProperties().isFirstLaunch()) {
            ...
            int answer =
                    JOptionPane.showConfirmDialog(mainPanel,
                            getContext().getResourceMap().getString("Application.firstLaunch"), applicationTitle,
        ...
        /*
         * se è abilitato il controllo degli aggiornamenti allora avvio il processo in background
         */
    ...
    /**
     * Bean di comunicazione tra la classe di lancio dell'applicazione (framework BSAF) e il framework di Spring.
     * 
     * @author Giuseppe Caliendo
     */
    @Component
