 ...
 * <br>
 * <br>
 * Estensione dello split standard che ovvia al problema di impostazione della
 * posizione del divider. Vedi
 * http://stackoverflow.com/questions/1879091/jsplitpane
 * -setdividerlocation-problem
 * 
...
public class JXSplitPane extends JSplitPane
{
	...
	/**
	 * Crea un {@link JSplitPane} impostando l'orientamento del componente e i
	 * componenti stessi
	 * 
	 * @param newOrientation
	 ...
	 */
	public JXSplitPane(int newOrientation, Component newLeftComponent,
	  Component newRightComponent)
	{
		super(newOrientation, UIManager.getBoolean("SplitPane.continuousLayout"),
