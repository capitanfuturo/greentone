 ...
 * </code> <br>
 * <br>
 * Pannello di riepilogo di un cliente. Mostra i dati di testata e gli incarichi del cliente oggetto del pannello.
 * 
...
public class PersonPanel extends AbstractPanel {
    ...
    /**
     * Restituisce il pulsante per tornare alla vista con gli incarichi della scheda.
     * 
    ...
    /**
     * Restituisce il pulsante che permette di passare dalla vista tabellare al dettaglio dell'incarico selezionato.
     * 
     * @return il pulsante che permette di passare dalla vista tabellare al dettaglio dell'incarico selezionato
     */
    ...
    private void loadJobs() {
        ...
        jobsTableModel =
                new EventJXTableModel<Job>(jobsEventList, new BeanTableFormat<Job>(Job.class, jobsProperties,
                        jobsColumnsNames, jobsWritables));
