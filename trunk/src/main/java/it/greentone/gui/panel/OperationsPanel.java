 ...
 * </code> <br>
 * <br>
 * Pannello di gestione delle operazioni degli incarichi dello studio professionale.
 * 
...
public class OperationsPanel extends ContextualPanel<Operation> {
    ...
    public OperationsPanel() {
        ...
        tableProperties =
                new String[] { "description", "job", "operationType", "isVacazione", "isProfessionalVacazione",
                        "operationDate", "amount", "numVacazioni" };
        tableColumnsNames =
                new String[] { getResourceMap().getString(LOCALIZATION_PREFIX + "Table.description"),
                        ...
                        getResourceMap().getString(LOCALIZATION_PREFIX + "Table.isProfessionalVacazione"),
    ...
    protected JPanel createHeaderPanel() {
        ...
        professionalVacazioneLabel =
                new JLabel(getResourceMap().getString(LOCALIZATION_PREFIX + "isProfessionalVacazione"));
            ...
            typeComboBox.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    if (typeComboBox.getSelectedIndex() > -1) {
                        /*
                         * Issue 57: mostrare i seguenti campi solo se il tipo di operazione è lavoro: On. a vacazione,
                         * Vacazione aiutante, Vacazioni.
                         */
    ...
    public JCheckBox getVacazioneCheckBox() {
        if (vacazioneCheckBox == null) {
            ...
            /*
             * Issue 33: alla selezione del flag On. a vacazione, la voce Importo deve modificarsi in Vacazioni. Il
             * campo Vacazioni, con flag On. a vacazione, deve contenere numeri senza decimali
             */
    ...
    /**
     * Restituisce il flag che dichiara se l'operazione è a vacazione di un aiutante.
     * 
    ...
    /**
     * Issue 32: Controlla che sia possibile abilitare l'azione di salvataggio di un'operazione:
     * <ul>
    ...
    private void toggleSaveAction() {
        saveOperationAction.setSaveOperationActionEnabled(GreenToneUtilities.getText(getDescriptionTextField()) != null
                && getJobComboBox().getSelectedItem() != null && getTypeComboBox().getSelectedItem() != null);
    }
    ...
    public void initializeForEditing() {
        ...
        getTypeComboBox().setSelectedItem(
                selectedOperation.getOperationType() != null ? selectedOperation.getOperationType().getLocalizedName()
                        : null);
        ...
        getOperationDate().setDate(
                selectedOperation.getOperationDate() != null ? selectedOperation.getOperationDate().toDate() : null);
        ...
        /*
         * abilito i campi di importo e vacazione a seconda che il flag sia abilitato
         */
    ...
    public void populateModel() {
        ...
        tableModel =
                new EventJXTableModel<Operation>(operationService.getAllOperations(), new BeanTableFormat<Operation>(
                        Operation.class, tableProperties, tableColumnsNames, tableWritables));
