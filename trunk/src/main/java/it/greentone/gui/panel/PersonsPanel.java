...
public class PersonsPanel extends ContextualPanel<Person> {
    ...
    public PersonsPanel() {
        ...
        properties =
                new String[] { "name", "address", "city", "province", "cap", "isLegal", "cf", "piva", "identityCard",
                        "telephone1", "telephone2", "fax", "email" };
        columnsNames =
                new String[] { getResourceMap().getString(LOCALIZATION_PREFIX + "Table.name"),
    ...
    public JFormattedTextField getCfTexField() {
        if (cfTextField == null) {
            ...
            /*
             * Issue 25: se è obbligatorio il codice fiscale, flag legale non impostato, allora in caso di
             * malformattazione del codice fiscale far comparire un popup che spiega il problema
             */
    ...
    /**
     * Mostra una finestra di dialogo che informa come inserire il campo codice fiscale.
     */
    private void showCFMessageDialog() {
        JOptionPane.showMessageDialog(this, getResourceMap().getString(LOCALIZATION_PREFIX + "cfMessage"),
                getResourceMap().getString(LOCALIZATION_PREFIX + "infoTitle"), JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void populateModel() {
        ...
        tableModel =
                new EventJXTableModel<Person>(personService.getAllPersons(), new BeanTableFormat<Person>(Person.class,
                        properties, columnsNames, writables));
