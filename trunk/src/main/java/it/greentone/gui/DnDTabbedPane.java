...
/**
 * Tabbedpane con supporto al drag & drop. http://java-swing-tips.blogspot.com/2008/04/drag-and-drop-tabs-in-jtabbedpane
 * .html
 */
...
public class DnDTabbedPane extends JTabbedPane {
    ...
    /* xxx magic number of scroll button size */
    ...
    /**
     * Tabbedpane con supporto al drag & drop. http://java-swing-tips.blogspot.com/
     * 2008/04/drag-and-drop-tabs-in-jtabbedpane .html
     */
    public DnDTabbedPane() {
        ...
        final DragSourceListener dsl = new DragSourceListener() {
            ...
            public void dragOver(DragSourceDragEvent e) {
                ...
                // if(getTabAreaBounds().contains(ctabPt) && targetIdx>=0 &&
    ...
    /**
     * Return <code>true</code> if the tabbed pane has a ghost, <code>false</code> otherwise.
     * 
     * @return <code>true</code> if the tabbed pane has a ghost, <code>false</code> otherwise
     */
    ...
    private void convertTab(int prev, int next) {
        /*
         * GreenTone: non voglio che si possa spostare una scheda in prima posizione perchè rimane fissa la pagina
         * iniziale
         */
        ...
        /*
         * When you drag'n'drop a disabled tab, it finishes enabled and selected. pointed out by dlorde
         */
        if (flg)
         ...
         * disappear. pointed out by Daniel Dario Morales Salas
         */
    ...
    private Rectangle getTabAreaBounds() {
        ...
        /*
         * pointed out by daryl. NullPointerException: i.e. addTab("Tab",null) Rectangle compRect =
         * getSelectedComponent().getBounds();
         */
