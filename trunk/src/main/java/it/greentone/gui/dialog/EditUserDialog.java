 ...
 * </code> <br>
 * <br>
 * Finestra di dialogo dedicata alla gestione della login di una persona in anagrafica.
 * 
...
public class EditUserDialog extends JDialog {
    ...
    public EditUserDialog() {
        ...
        JLabel nameLabel = new JLabel(resourceMap.getString(LOCALIZATION_PREFIX + "name"));
        JLabel usernameLabel = new JLabel(resourceMap.getString(LOCALIZATION_PREFIX + "username"));
        JLabel passwordLabel = new JLabel(resourceMap.getString(LOCALIZATION_PREFIX + "password"));
        JLabel isActiveLabel = new JLabel(resourceMap.getString(LOCALIZATION_PREFIX + "active"));
        JLabel activationDateLabel = new JLabel(resourceMap.getString(LOCALIZATION_PREFIX + "activationDate"));
        JLabel profileLabel = new JLabel(resourceMap.getString(LOCALIZATION_PREFIX + "profile"));
        ...
        if (okAction == null) {
            okAction = new AbstractAction() {
                ...
                public void actionPerformed(ActionEvent e) {
                    person.setUsername(GreenToneUtilities.getText(getUsernameTextField()));
                    ...
                    if (getIsActiveCheckBox().isSelected()) {
                        DateTime dt = new DateTime(Calendar.getInstance().getTimeInMillis());
    ...
    public void setup(Person person) {
        ...
        if (person.getActivationDate() != null) {
            getActivationDateContentLabel().setText(person.getActivationDate().toString("dd/MM/yyyy"));
        } else {
