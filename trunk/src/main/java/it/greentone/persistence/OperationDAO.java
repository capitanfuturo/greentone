...
public class OperationDAO extends JdoDaoSupport {
    ...
    public Operation loadOperation(final long id) throws DataAccessException {
        final Operation operation = getJdoTemplate().getObjectById(Operation.class, Long.valueOf(id));
        if (operation == null)
     ...
     * @throws DataAccessException
     */
    public void storeOperation(final Operation operation) throws DataAccessException {
     ...
     * @throws DataAccessException
     */
    public void deleteOperation(final Operation operation) throws DataAccessException {
    ...
    public Collection<Operation> getAllOperations() throws DataAccessException {
        return getPersistenceManager().detachCopyAll(getJdoTemplate().find(Operation.class));
    }
     ...
     * @throws DataAccessException
     */
    public Collection<Operation> getOperationsJob(Job job) throws DataAccessException {
        Query query =
        ...
        Collection<Operation> result =
                getPersistenceManager().detachCopyAll((Collection<Operation>) query.execute(job));
        return result;
    }
}
