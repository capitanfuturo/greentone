...
public class DocumentService {
    ...
    private final EventList<Document> allDocuments = new BasicEventList<Document>();
    ...
    public void addDocument(Document document) {
        ...
        Metadata metadata = metadataService.getMetadataFromName(MetadataService.DOCUMENT_LAST_PROTOCOL);
        if (metadata != null) {
    ...
    /**
     * Restituisce il prossimo protocollo utile da utilizzare. Il protocollo per i documenti è del tipo 00001-2011
     * 
    ...
    public String getNextProtocol() {
        ...
        if (metadata != null) {
            ...
            /* recupero l'anno */
            String protocolYear =
                    lastProtocol.substring(ConfigurationProperties.DOCUMENT_PROTOCOL_NUMERIC_LENGHT
        ...
        String protocol =
                GreenToneUtilities.leftPadding(counter, ConfigurationProperties.DOCUMENT_PADDING_CHAR,
                        ConfigurationProperties.DOCUMENT_PROTOCOL_NUMERIC_LENGHT);
        protocol = protocol + ConfigurationProperties.DOCUMENT_PROTOCOL_SEPARATOR + year;
        return protocol;
    }
}
